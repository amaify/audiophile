...
const Thumbnail = ({ title, img, onClick }: Props) => {
  return (
    <div className="bg-darkGrey w-full h-[20.4rem] relative rounded-lg sm:h-[16.5rem] md:w-1/3">
      <div className="absolute -bottom-[2.5rem] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[22rem] h-auto sm:w-[16rem] sm:bottom-0">
