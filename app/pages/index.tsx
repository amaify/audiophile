...
const Home: NextPage = () => {
  return (
    <section>
      <Hero />
      <div className="mt-[200px] mb-[168px] px-[17.5em] relative">
        <ProductThumbnails />
      </div>

      <div className="mb-[200px] px-[17.5rem] relative w-full">
        <div className="flex flex-col gap-[48px]">
          ...
          <div className="relative w-full">
            <Image src={Speakerzx7Image} alt="ZX7 Speaker" sizes="full" className="rounded-lg w-full h-full" />
